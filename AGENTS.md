...
- before writing automated tests for given page explore that it works using `playwright-cli`. Use dedicated skill which is present in `.claude/skills/playwright-cli/SKILL.md` file. Do that with tracing enabled.
